...
**Please hold off on following this guide with the latest commimit of OpenCorePkg, numerous changes were made and so this guide requires a clean up**
...
* ~~Currently minimal support for emulated NVRAM (sorry z390 users, EmuVariableRuntimeDxe may work but won't save on reboot).~~ Support for nvram.plist has been added to OpenCore most recent commit
